...
import EmptyAvatar from 'src/components/Form/Avatar';
import {ButtonBigGreen, ButtonMediumGreen} from "src/styles/Button.module";
// @ts-ignore
import {BlockWrapperGreen} from "styles/Main.module";
import {AddWatermarkBlock, BigSquare, BlockEmptyImage} from "src/styles/AddWatermark.module";
// @ts-ignore
